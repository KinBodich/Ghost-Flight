...
namespace Nova
{
    ...
    public sealed class Scroller : GestureRecognizer, InternalType_489
    {
        ...
        InternalType_77 InternalType_75.InternalMethod_3340<T>(Ray InternalParameter_329, InternalType_76<T> InternalParameter_328, InternalType_76<T> InternalParameter_2232, Transform InternalParameter_2233)
        {
            ...
            {
                _ = InternalParameter_328.InternalMethod_474(out InternalType_76<InternalType_755<Vector3>>? InternalVar_5);
                _ = InternalParameter_2232.InternalMethod_474(out InternalType_76<InternalType_755<Vector3>>? InternalVar_6);
                Vector3 InternalVar_7 = InternalVar_6.Value.InternalField_247.InternalField_3546 - InternalVar_5.Value.InternalField_247.InternalField_3546;
        ...
        bool InternalType_754.InternalMethod_3559(Vector3 InternalParameter_3234)
        {
            ...
            {
                return !InternalMethod_1987(InternalVar_1);
            }
        ...
        void InternalType_754.InternalMethod_3560(InternalType_5 InternalParameter_3235, InternalType_5 InternalParameter_3236, Vector3 InternalParameter_3237)
        {
            if (!InternalProperty_164)
            {
                return;
            ...
            if (!InternalType_182.InternalMethod_3638(UIBlock, InternalParameter_3237, out int InternalVar_1, out int InternalVar_2))
            {
                return;
            }

            if (InternalParameter_3235 == null)
            {
                if (InternalMethod_1987(InternalVar_2))
                {
                    float InternalVar_3 = UIBlock.InternalMethod_3595(0).InternalProperty_150[InternalVar_1] + UIBlock.CalculatedSpacing.Value;
                    Scroll(InternalVar_3 * -InternalVar_2);
                }

                return;
            }

            if (InternalParameter_3236 == null)
            {
                if (InternalMethod_1987(InternalVar_2))
                {
                    float InternalVar_3 = (InternalParameter_3235.InternalProperty_150[InternalVar_1] + UIBlock.CalculatedSpacing.Value) * -InternalParameter_3237[InternalVar_1];
            ...
            if (InternalMethod_1034(InternalParameter_3236, InternalVar_1))
            {
                float InternalVar_3 = InternalType_182.InternalMethod_3654(InternalParameter_3236, InternalVar_1, UIBlock.InternalMethod_79().Alignment);
                float InternalVar_4 = (InternalParameter_3236.InternalProperty_150[InternalVar_1] + UIBlock.CalculatedSpacing.Value) * -InternalParameter_3237[InternalVar_1];
            ...
            if (!InternalMethod_2027(InternalParameter_3236, InternalVar_1))
            {
                int InternalVar_3 = 0;

                if (InternalProperty_912)
                {
                    InternalType_5 InternalVar_4 = InternalParameter_3236.InternalProperty_203 ? InternalParameter_3236.InternalMethod_3595(0) : InternalParameter_3236;
                ...
                {
                    InternalVar_3 = UIBlock.InternalMethod_3594(InternalParameter_3236);
                }
        ...
        private bool InternalMethod_1987(int InternalParameter_1789)
        {
            ...
            return InternalType_187.InternalMethod_871(InternalVar_2) < InternalType_187.InternalMethod_871(InternalVar_3);
        }
