...
namespace Nova.InternalNamespace_17.InternalNamespace_18
{
    internal static class InternalType_573
    {
        ...
        public static Color InternalMethod_2250(Rect InternalParameter_3427, GUIContent InternalParameter_2207, Color InternalParameter_3444, bool InternalParameter_3445, bool InternalParameter_3446 = true)
        {
            ...
            bool InternalVar_4 = EditorGUI.showMixedValue;

            EditorGUI.showMixedValue = InternalParameter_3445;

            Rect InternalVar_5 = InternalParameter_3427;
            Rect InternalVar_6 = InternalParameter_3427;

            if (!InternalParameter_3445)
            {
                InternalVar_5.width = 2 * InternalField_3636 + EditorStyles.numberField.padding.horizontal + InternalVar_3;
                InternalVar_6.xMin = InternalVar_5.xMax - InternalField_2557;

                InternalProperty_472 = InternalVar_3;

                InternalParameter_3444.a = Mathf.Clamp01(EditorGUI.IntField(InternalVar_5, InternalType_554.InternalField_3627, Mathf.RoundToInt(100 * InternalParameter_3444.a)) / 100f);
            }

            InternalParameter_3444 = EditorGUI.ColorField(InternalVar_6, GUIContent.none, InternalParameter_3444, showEyedropper: true, showAlpha: InternalParameter_3446, hdr: false);

            EditorGUI.showMixedValue = InternalVar_4;
