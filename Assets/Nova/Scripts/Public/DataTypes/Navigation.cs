...
namespace Nova
{
    ...
    public static class Navigation
    {
        ...
        public static void Move(Vector3 direction, uint controlID = 0, object userData = null, int layerMask = AllLayers)
        {
            ...
            UIBlock InternalVar_2 = InternalType_757<UIBlock>.InternalMethod_3570(controlID);

            bool InternalVar_3 = InternalVar_2 != null && InternalVar_2.InternalProperty_23.InternalProperty_1152;

            direction.Normalize();

            if (InternalVar_3)
            {
                Update InternalVar_4 = new Update(InternalType_757<UIBlock>.InternalMethod_3583(direction, InternalVar_2, InternalParameter_3305: true), controlID, userData);
                InternalVar_2.InternalMethod_91(Navigate.InternalMethod_461(InternalVar_4, InternalVar_2, direction));
                return;
            }

            InternalType_738 InternalVar_6 = InternalType_757<UIBlock>.InternalMethod_3576(InternalVar_1, InternalVar_2, direction, layerMask, out InternalType_5 InternalVar_5) ?
                              InternalType_738.InternalMethod_2801(InternalVar_1, InternalVar_5 as UIBlock, new Update(InternalType_757<UIBlock>.InternalMethod_3583(direction, InternalVar_1), controlID, userData), direction, layerMask) :
                              InternalType_738.InternalMethod_2815(controlID, direction, userData, layerMask);

            InternalProperty_1082.Add(InternalVar_6);
        }
        ...
        private static void InternalMethod_2689(InternalType_95 InternalParameter_2910, InternalType_738 InternalParameter_2459)
        {
            ...
            InternalType_521<UIBlock> InternalVar_15 = InternalType_757<UIBlock>.InternalMethod_3585(InternalVar_1, InternalType_757<UIBlock>.InternalMethod_3570(InternalVar_3.ControlID), InternalVar_5);
